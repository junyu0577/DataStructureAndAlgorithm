...
/*    A website domain like "discuss.leetcode.com" consists of various subdomains.
    ...
    /**
     * 统计子域名访问次数
     * 利用subString和indexOf进行字符串的截取，然后将截取后的存放进hash表进行次数的统计。
     *
     * @param cpdomains
     * @return
     */
    ...
    public static void main(String[] args) {
        System.out.println(new _811_Subdomain_Visit_Count().subdomainVisits(new String[]{"9001 discuss.leetcode.com"}));
        System.out.println(new _811_Subdomain_Visit_Count().subdomainVisits(new String[]{"900 google.mail.com", "50 yahoo.com", "1 intel.mail.com", "5 wiki.org"}));
    }
}
